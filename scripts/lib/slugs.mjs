...
export const GUIDE_PAGES = [
  ...
  // FR nouvelles pages
  { lang: 'fr', page: 'algorithme-local', topic: 'Google local algorithm, relevance distance prominence, search ranking factors, magnifying glass map' },
  { lang: 'fr', page: 'pack-local', topic: 'Google local pack 3-pack, three business listings with map, local search results' },
  { lang: 'fr', page: 'mots-cles-locaux', topic: 'local keyword research, search bar with city pin, keyword analysis tools' },
  { lang: 'fr', page: 'pages-service-ville', topic: 'city service landing page, local landing pages, city skyline with business icons' },
  { lang: 'fr', page: 'schema-local', topic: 'structured data JSON-LD schema, local business markup, rich results code' },
  { lang: 'fr', page: 'mobile-vitesse', topic: 'mobile page speed, smartphone loading fast, Core Web Vitals performance' },
  { lang: 'fr', page: 'annuaires-locaux', topic: 'local business directories, online listings, directory icons, NAP citations' },
  { lang: 'fr', page: 'repondre-avis', topic: 'responding to customer reviews, business owner replying, review management' },
  { lang: 'fr', page: 'restaurants', topic: 'restaurant local SEO, restaurant storefront, food business Google Maps' },
  { lang: 'fr', page: 'artisans', topic: 'tradesperson local SEO, plumber electrician tools, artisan small business' },
  { lang: 'fr', page: 'sante', topic: 'healthcare professional local SEO, medical office, doctor with map pin' },
  { lang: 'fr', page: 'professions-liberales', topic: 'professional services local SEO, lawyer accountant office, professional workspace' },
  { lang: 'fr', page: 'outils-seo', topic: 'local SEO tools dashboard, analytics software, SEO analysis screen' },
  { lang: 'fr', page: 'mesurer-resultats', topic: 'local SEO results measurement, analytics dashboard, KPI charts growth' },
  // EN nouvelles pages
  { lang: 'en', page: 'local-algorithm', topic: 'Google local algorithm, relevance distance prominence, search ranking factors' },
  { lang: 'en', page: 'local-pack', topic: 'Google local pack 3-pack, three business listings with map, local search results' },
  { lang: 'en', page: 'local-keywords', topic: 'local keyword research, search bar with city pin, keyword analysis tools' },
  { lang: 'en', page: 'service-area-pages', topic: 'city service landing page, local landing pages, city map with service icons' },
  { lang: 'en', page: 'local-schema', topic: 'structured data JSON-LD schema, local business markup, rich results code' },
  { lang: 'en', page: 'mobile-speed', topic: 'mobile page speed, smartphone loading fast, Core Web Vitals performance' },
  { lang: 'en', page: 'local-directories', topic: 'local business directories, online listings, directory icons, NAP citations' },
  { lang: 'en', page: 'responding-reviews', topic: 'responding to customer reviews, business owner replying, review management' },
  { lang: 'en', page: 'restaurants', topic: 'restaurant local SEO, restaurant storefront, food business Google Maps' },
  { lang: 'en', page: 'tradespeople', topic: 'tradesperson local SEO, plumber electrician tools, artisan small business' },
  { lang: 'en', page: 'healthcare', topic: 'healthcare professional local SEO, medical office, doctor with map pin' },
  { lang: 'en', page: 'professional-services', topic: 'professional services local SEO, lawyer accountant office, professional workspace' },
  { lang: 'en', page: 'seo-tools', topic: 'local SEO tools dashboard, analytics software, SEO analysis screen' },
  { lang: 'en', page: 'measuring-results', topic: 'local SEO results measurement, analytics dashboard, KPI charts growth' },
  // ES nouvelles pages
  { lang: 'es', page: 'algoritmo-local', topic: 'Google local algorithm, relevance distance prominence, search ranking factors' },
  { lang: 'es', page: 'paquete-local', topic: 'Google local pack 3-pack, three business listings with map, local search results' },
  { lang: 'es', page: 'palabras-clave-locales', topic: 'local keyword research, search bar with city pin, keyword analysis tools' },
  { lang: 'es', page: 'paginas-servicio-ciudad', topic: 'city service landing page, local landing pages, city skyline with service icons' },
  { lang: 'es', page: 'schema-local', topic: 'structured data JSON-LD schema, local business markup, rich results code' },
  { lang: 'es', page: 'movil-velocidad', topic: 'mobile page speed, smartphone loading fast, Core Web Vitals performance' },
  { lang: 'es', page: 'directorios-locales', topic: 'local business directories, online listings, directory icons, NAP citations' },
  { lang: 'es', page: 'responder-resenas', topic: 'responding to customer reviews, business owner replying, review management' },
  { lang: 'es', page: 'restaurantes', topic: 'restaurant local SEO, restaurant storefront, food business Google Maps' },
  { lang: 'es', page: 'artesanos', topic: 'tradesperson local SEO, plumber electrician tools, artisan small business' },
  { lang: 'es', page: 'salud', topic: 'healthcare professional local SEO, medical office, doctor with map pin' },
  { lang: 'es', page: 'profesiones-liberales', topic: 'professional services local SEO, lawyer accountant office, professional workspace' },
  { lang: 'es', page: 'herramientas-seo', topic: 'local SEO tools dashboard, analytics software, SEO analysis screen' },
  { lang: 'es', page: 'medir-resultados', topic: 'local SEO results measurement, analytics dashboard, KPI charts growth' },
].map(g => ({
  ...g,
